...
#define APP_URL         "https://github.com/sweatpotato13/Sigpatch-Updater/releases/download/1.2.0/sigpatch-updater.nro"
#define VERSION_URL     "https://github.com/sweatpotato13/Sigpatches/releases/download/1.0.0/version"
